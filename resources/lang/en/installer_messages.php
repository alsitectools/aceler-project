<?php return [
    ...
    'permissions' => [
        ...
        'title' => 'Permissions', 'next' => 'Configure Environment',
    ],
    'environment' => [
        'menu' => [
