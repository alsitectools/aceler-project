                        ...
                        <div class="avatar-sm">
                            @if (in_array($file->extension, ['.jpg', '.jpeg', '.png', '.gif', '.bmp']))
                                <span class="avatar-title rounded">
                                    <img src="{{ asset($logo_tasks . $file->file) }}" class="preview_img_size"
                                        id="" />
                                    {{-- {{$file->extension}} --}}
                                </span>
                            @else
                                <span class="avatar-title rounded">
                                    <img src="{{ asset($logo_tasks . 'sample-file.png') }}" class="preview_img_size"
                                        id="" />
                                </span>
                            @endif
                        </div>
...
<div class="tab-pane fade mt-3" id="sub-task-data" role="tabpanel" aria-labelledby="contact-tab">
    <div class="text-end mb-3">
        <a href="#" class="btn btn-sm btn-primary" data-toggle="collapse" data-target="#form-subtask"> <i
