        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade mt-3" id="sub-task-data" role="tabpanel" aria-labelledby="contact-tab">
                ...
                <form method="post" id="form-subtask" class="collapse"
                    data-action="{{ route('subtask.store', [$currentWorkspace->slug, $task->project_id, $task->id, $clientID]) }}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                        ...
                        <li class="list-group-item py-3">
                            <div class="form-check form-switch d-inline-block">
                                <input type="checkbox" class="form-check-input" name="option"
                                    ...
                                    data-url="{{ route('subtask.update', [$currentWorkspace->slug, $task->project_id, $subTask->id]) }}">
                            ...
                            <div class="text-end row_line_style">
                                <a href="#"
                                    ...
                                    data-url="{{ route('subtask.destroy', [$currentWorkspace->slug, $task->project_id, $subTask->id]) }}">
                                    <i class="ti ti-trash"></i>
                                </a>
                            </div>
                        </li>
