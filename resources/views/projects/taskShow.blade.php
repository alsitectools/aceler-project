        ...
        <div>
            <div>
                ...
                <div class="divIconModified">
                    ...
                    <p class="textStyle" title="{{ $taskDetail['milestone'] }}">
            ...
            <div>
                <div class="divIconModified">
                    ...
                    <p class="textStyleModified">{{ \App\Models\Utility::dateFormat($taskDetail['task']->start_date) }}
                    </p>
                </div>
                <div class="divIconTexts">
                    <i class="fa-solid fa-helmet-safety customIconsStlye"></i>
                    <img @if ($taskDetail['assign_to']->avatar) src="{{ asset($logo . $taskDetail['assign_to']) }}" 
