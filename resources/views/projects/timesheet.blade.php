...
@if ($project_id != -1)
<li class="breadcrumb-item"><a href="{{ route('projects.show', [$currentWorkspace->slug, $project_id]) }}">{{
        $project_name }}</a>
</li>
@endif
...
<div class="d-flex justify-content-end row1">
    ...
    <div class="col-sm-auto">
        <button id="add_task" type="button" class="btn btn-primary add_task" data-ajax-popup="true" data-size="lg"
            data-title="{{ __('Create New Task') }}" data-url="{{ route('tasks.create', $currentWorkspace->slug) }}"
            title="{{ __('Add Task') }}"><i class="fa-solid fa-thumbtack"></i>
