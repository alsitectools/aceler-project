        ...
        <div class="tab-pane fade show active" id="milestone" role="tabpanel" aria-labelledby="milestone-tab">
            <form id="milestone-form" method="POST" action="{{ $actionUrl }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="projectIdDisabled" value="{{ $project->name }}"
                                disabled>
                    ...
                    <div class="col-md-12">
                        <p class="text-muted">
                            <i class="bi bi-info-circle me-2" style="color: #FFD43B;"></i>{{ __('If the project does not
                            exist, create a new project.') }}
                        </p>
                    </div>
                    ...
                    <div class="col-md-6" id="requestBy">
                        ...
                        <div id="user-select" aria-label="Default select example" class="dropdown-menu"
                            ...
                            @endforeach
                            <input type="hidden" name="assing_to" id="assing_To" value="{{ Auth::user()->id }}">
                        </div>
                    </div>
                ...
                <div class="form-check form-switch mb-3" id="visado" style="display: none">
                    ...
                    <label class="form-check-label" for="toggleFormSwitch">{{ __('Only in case it is necessary to to
                        carry out a project with a visa.') }}</label>
                </div>
                <div id="additionalForm" class="collapse mt-3">
                    <div class="card card-body">
                        <div class="mb-3">
                            <label for="input1" class="form-label">{{ __('Name of the company that will install the
                                system') }}:</label>
                            <input type="text" class="form-control" name="company" id="company"
                                placeholder="Ingrese valor">
                        </div>
                        <div class="mb-3">
                            <label for="input2" class="form-label">{{ __('Name of prime contractor') }}:</label>
                            <input type="text" class="form-control" name="contractor" id="contractor"
                                placeholder="Ingrese valor">
                        </div>
                        <div class="mb-3">
                            <label for="input2" class="form-label">{{ __('Address of prime contractor') }}:</label>
                            <input type="text" class="form-control" name="contractorAdress" id="contractorAdress"
                                placeholder="Ingrese valor">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input onclick="this.showPicker()" type="date" class="form-control form-control-light date"
                                id="end_date" value="" placeholder="{{ __('Date') }}" name="end_date" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-3" style="padding-bottom: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea style="height:82%" class="form-control mt-2" id="description-text"
                                name="description" rows="5" placeholder="{{ __('Enter description...') }}"></textarea>
                        </div>

                        <!-- Sección de Archivos Adjuntos (Derecha) -->
                        <div class="col-md-6">
                            <label for="file-uploadMilestone" class="form-label"><strong>{{ __('Upload files')
                                    }}</strong></label>
                            <div>
            ...
            <form class="" id="projectForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" id="clipo" style="display: none; position: relative">
