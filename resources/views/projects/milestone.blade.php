...
<form class="" method="post" action="@auth('web'){{ route('projects.milestone.store', [$currentWorkspace->slug, $project->id]) }}@endauth">
    @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="input-group date ">
                            <input class="form-control datepicker22" type="text" id="start_date" name="start_date" value="<?php echo date('Y-m-d'); ?>" autocomplete="off" disabled>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group date ">
                            <input class="form-control datepicker23" type="text" id="end_date" name="end_date" autocomplete="off">
                            <span class="input-group-text">
                                <i class="feather icon-calendar"></i>
                            </span>
                        </div>
