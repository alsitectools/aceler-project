                ...
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-4 text-center">
                            <h6>{{ 'Todos los espacios de trabajo' }}</h6>
                        ...
                        <div class="col-4 text-center">
                            <h6>{{ 'Espacio de trabajo activo' }}</h6>
                            <p class=" text-sm mb-0">
                        ...
                        <div class="col-4 text-center">
                            <h6>{{ 'Espacio de trabajo desactivado' }}</h6>
                            <p class=" text-sm mb-0">
                            ...
                            <div class="tab-pane text-capitalize fade show {{ $loop->index == 0 ? 'active' : '' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-11 col-md-10 col-sm-10 mt-3 text-end">
                                        <small
                                            class="text-danger my-3">{{ __('* Asegúrese de que si desactiva el espacio de trabajo, todos los usuarios de este espacio de trabajo también estén desactivados.') }}</small>
                                ...
                                <div class="row workspace" data-workspace-id={{ $workspace->id }}>
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Total tecnicos') }}"><i
                                    ...
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Tecnicos activos') }}"><i
                                    ...
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Tecnicos desactivados') }}"><i
