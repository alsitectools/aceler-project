...
//-----------------------AZURE --------------------------------------//
// Ruta para redirigir a Azure AD
Route::get('login/azure', [AzureController::class, 'redirectToAzure'])->name('azure.login');

// Ruta para manejar el callback de Azure AD
Route::get('login/azure/callback', [AzureController::class, 'handleAzureCallback'])->name('azure.callback');
