                        ...
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <?php if(Auth::user()->type == 'admin'): ?>
                                <a href="#workspace-settings"
                                    class="list-group-item list-group-item-action border-0 "><?php echo e(trans('messages.Workspace_Settings')); ?>

                                    <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                </a>
                                <a href="#task-stage-settings"
                                    class="list-group-item list-group-item-action border-0 "><?php echo e(trans('messages.Task_Stage_Settings')); ?>

                                    <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                </a>
                                <a href="#bug-stage-settings"
                                    class="list-group-item list-group-item-action border-0"><?php echo e(__('Bug Stage Settings')); ?>
                            ...
                            <div class="col-12">
                                <div class="card ">
                                    <div class="card-header">
                                        <h5><?php echo e(trans('messages.Workspace_Settings')); ?></h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="col-12">
                                            <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="changeLanguage">
                                                        ...
                                                        <select name="default_language" id="default_language"
                                                            ...
                                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $languageCode => $languageFullName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($languageCode); ?>"
                                                                    <?php if($DEFAULT_LANG == $languageCode): ?> selected <?php endif; ?>>
                                                                    <?php echo e($languageFullName); ?>
                                            ...
                                            <h4 class="small-title mb-4"><?php echo e(trans('messages.Theme_Customizer')); ?></h4>
                                            <div class="col-12">
                                                <div class="pct-body">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <h6 class="">
                                                                <i data-feather="credit-card"
                                                                    class="me-2"></i><?php echo e(trans('messages.Primary_color_settings')); ?>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <h6 class="">
                                                                <i data-feather="layout"
                                                                    class="me-2"></i><?php echo e(trans('messages.Sidebar_settings')); ?>
                                                            ...
                                                            <div class="form-check form-switch">
                                                                ...
                                                                <label class="form-check-label f-w-600 pl-1"
                                                                    for="cust-theme-bg"><?php echo e(trans('messages.Transparent_layout')); ?></label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <h6 class="">
                                                                <i data-feather="sun"
                                                                    class=""></i><?php echo e(trans('messages.Layout_settings')); ?>
                                                            ...
                                                            <div class="form-check form-switch mt-2">
                                                                ...
                                                                <label class="form-check-label f-w-600 pl-1"
                                                                    for="cust-darklayout"><?php echo e(trans('messages.Dark_Layout')); ?></label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                ...
                                <div class="card task-stages" data-value="<?php echo e(json_encode($stages)); ?>"
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-11">
                                                <h5 class="pb-2">
                                                    <?php echo e(trans('messages.Task_Stage_Settings')); ?>


                                                </h5>
                                                <small
                                                    class=""><?php echo e(trans('messages.System_will_consider_the_last_stage_as_a_completed/done_project_or_task_status.')); ?></small>
                                            </div>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-11">
                                                ...
                                                <small
                                                    class=""><?php echo e(trans('messages.System_will_consider_the_last_stage_as_a_completed/done_project_or_bug_status.')); ?></small>
                                            </div>
                                            <div class=" col-auto text-end">
                                                <button data-repeater-create type="button"
                                    ...
                                    <div class="col-lg-12 ">
                                        <div class="row">
                                            ...
                                            <div class="text-start text-light col-6">
                                                <a data-size="md" data-url="<?php echo e(route('test.email')); ?>"
