        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-8">
                    ...
                    <select class="form-control form-control-light select2" name="project_id" disabled>
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class=" multi-select" id="assign_to" name="assign_to[]" data-toggle="select2"
                        multiple="multiple" data-placeholder="<?php echo e(__('Select Users ...')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/projects/taskCreate.blade.php ENDPATH**/ ?>