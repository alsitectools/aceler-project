...
<head>
    ...
    <?php if(Auth::user()->type == 'admin'): ?>
        <link rel="shortcut icon" href="<?php echo e(asset($logo . 'favicon.png' . '?' . time())); ?>">
    <?php else: ?>
        <link rel="shortcut icon"
            href="<?php if($currentWorkspace->favicon): ?> <?php echo e(asset($logo . $currentWorkspace->favicon . '?' . time())); ?><?php else: ?><?php echo e(asset($logo . 'favicon.png' . '?' . time())); ?> <?php endif; ?>">
    <?php endif; ?>
...
<body class="<?php echo e($color); ?>">
    ...
    <?php if(Auth::user()->getGuard() == 'client'): ?>
        <input type="hidden" id="path_admin"
            value="<?php echo e(url(isset($currentWorkspace) ? 'client/' . $currentWorkspace->slug : '')); ?>">
    <?php else: ?>
        <input type="hidden" id="path_admin"
            value="<?php echo e(url(isset($currentWorkspace) ? $currentWorkspace->slug : '')); ?>">
    <?php endif; ?>
                                ...
                                <div class="col header_breadcrumb">
                                    ...
                                    <?php elseif(trim($__env->yieldContent('multiple-action-button'))): ?>
                                        <div class=" row text-end row d-flex justify-content-end col-auto ">
                                            <?php echo $__env->yieldContent('multiple-action-button'); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="text" id="workspacename" name="name"
                                            required="" placeholder="<?php echo e(__('Workspace Name')); ?>">
                                    </div>
                                </div>
                        </div>
    ...
    <script>
        var date_picker_locale = {
            format: 'YYYY-MM-DD',
            daysOfWeek: [
                "<?php echo e(trans('messages.Sun')); ?>",
                "<?php echo e(trans('messages.Mon')); ?>",
                "<?php echo e(trans('messages.Tue')); ?>",
                "<?php echo e(trans('messages.Wed')); ?>",
                "<?php echo e(trans('messages.Thu')); ?>",
                "<?php echo e(trans('messages.Fri')); ?>",
                "<?php echo e(trans('messages.Sat')); ?>"
            ],
            monthNames: [
                '<?php echo e(trans('messages.January')); ?>',
                '<?php echo e(trans('messages.February')); ?>',
                ' <?php echo e(trans('messages.March')); ?>',
                '<?php echo e(trans('messages.April')); ?>',
                '<?php echo e(trans('messages.May')); ?>',
                '<?php echo e(trans('messages.June')); ?>',
                '<?php echo e(trans('messages.July')); ?>',
                '<?php echo e(trans('messages.August')); ?>',
                '<?php echo e(trans('messages.September')); ?>',
                '<?php echo e(trans('messages.October')); ?>',
                '<?php echo e(trans('messages.November')); ?>',
                ' <?php echo e(trans('messages.December')); ?>'
            ],
        };
        var calender_header = {
    ...
    <?php if(isset($currentWorkspace) && $currentWorkspace): ?>
        ...
        <script>
            var options = {
                url: function(phrase) {
                    return "<?php if(auth()->guard('web')->check()): ?><?php echo e(route('search.json', $currentWorkspace->slug)); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.search.json', $currentWorkspace->slug)); ?><?php endif; ?>/" +
                        phrase;
                },
                categories: [{
...
<?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/layouts/admin.blade.php ENDPATH**/ ?>