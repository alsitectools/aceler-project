...
<?php $__env->startSection('action-button'); ?>
    <?php if(auth()->guard('web')->check()): ?>
        <a href="<?php echo e(route('project.export')); ?>" class="btn btn-sm btn-primary " data-toggle="tooltip"
            title="<?php echo e(__('Export Project')); ?>"> <i class="ti ti-file-x"></i></a>
        ...
        <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-title="<?php echo e(__('Import Project')); ?>"
            ...
            title="<?php echo e(__('Import Project')); ?>"><i class="ti ti-file-import"></i> </a>

        <?php if(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id()): ?>
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                data-title="<?php echo e(__('Create New Project')); ?>" data-url="<?php echo e(route('projects.create', $currentWorkspace->slug)); ?>"
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 All <?php echo e($project->status); ?>">
                        <div class="card">
                                                ...
                                                <?php if($project->is_active): ?>
                                                    ...
                                                    <?php if(\Auth::user()->type == 'admin'): ?>
                                                        <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                            ...
                                                            data-url="<?php echo e(route('projects.invite.popup', [$currentWorkspace->slug, $project->id])); ?>">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="text-muted"><?php echo e(trans('messages.MEMBERS')); ?></h6>
