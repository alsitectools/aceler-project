...
<?php endif; ?>
<li class="breadcrumb-item"> <?php echo e(trans('Projects')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <div class="row grid">
                ...
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.show', [$currentWorkspace->slug, $project->id])); ?><?php endif; ?>" class="">
                            ...
                            <h5 class="mb-0">
                                <?php if($project->is_active): ?>
                                <a href="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('projects.show', [$currentWorkspace->slug, $project->id])); ?><?php endif; ?>" title="<?php echo e($project->name); ?>" class="">
                        ...
                        <div class="card-header-right">
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="#" class="dropdown-item text-danger delete-popup bs-pass-para" data-confirm="<?php echo e(__('Are You Sure?')); ?>" data-text="<?php echo e(trans('messages.This_action_can_not_be_undone._Do_you_want_to_continue?')); ?>" data-confirm-yes="delete-form-<?php echo e($project->id); ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-0 mt-3">
                            <div class="card-body p-3">
                                <div class="row">
                                    <?php if(isset($project_type[$project->type - 1]) &&
                                    $project_type[$project->type - 1]->id == $project->type): ?>
                                    <div class="col-6 text">
                                        <span class="text-muted"><b><?php echo e($project_type[$project->type - 1]->name); ?></b></span>
                                        <span class="text-muted"><b><?php echo e($project->ref_mo); ?></b></span>
                                    </div>
                                    <div class="col-6">
                                        <p aria-hidden="true">
                                            <img class="img-fluid" width="50px" src="<?php echo e(asset('assets/img/'.$project_type[$project->type - 1]->name .'.png')); ?>" alt="Project type">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 All add_projects">
                <a href="#" class="btn-addnew-project " style="padding: 90px 10px;" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Create New Project')); ?>" data-url="<?php echo e(route('projects.create', $currentWorkspace->slug)); ?>">
                    ...
                    <h6 class="mt-4 mb-2"><?php echo e(trans('Add Project')); ?></h6>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/projects/index.blade.php ENDPATH**/ ?>