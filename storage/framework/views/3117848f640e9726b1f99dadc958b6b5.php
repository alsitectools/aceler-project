    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-2 col-sm-6 pb-3">
            <select class="select2 form-select" name="status" id="status">
                ...
                <option value="Ongoing"><?php echo e(trans('Ongoing')); ?></option>
                <option value="Finished"><?php echo e(trans('Finished')); ?></option>
                <option value="OnHold"><?php echo e(trans('OnHold')); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/project_report/index.blade.php ENDPATH**/ ?>