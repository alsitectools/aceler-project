<?php if($project && $currentWorkspace && $task): ?>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control form-control-light select2" disabled>
                        <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option> <?php echo e($milestone->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control form-control-light" id="task-title"
                        placeholder="<?php echo e(__('Enter Title')); ?>" value="<?php echo e($task->title); ?>" disabled>
    ...
    <script>
        $(document).on('change', "select[name=project_id]", function() {
            $.get('<?php if(auth()->guard('web')->check()): ?><?php echo e(route('home')); ?><?php endif; ?>' +
