<?php if($project && $currentWorkspace && $task): ?>
    <form class="" method="post"
        action="<?php if(auth()->guard('web')->check()): ?><?php echo e(route('tasks.update', [$currentWorkspace->slug, $project->id, $task->id])); ?><?php elseif(auth()->guard()->check()): ?><?php echo e(route('client.tasks.update', [$currentWorkspace->slug, $project->id, $task->id])); ?><?php endif; ?>">
        <?php echo csrf_field(); ?>
                ...
                <div class="form-group col-md-8">
                    ...
                    <select class="form-control form-control-light select2" name="project_id" required>
                        <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($p->id); ?>" <?php if($task->project_id == $p->id): ?> selected <?php endif; ?>>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control form-control-light select2" name="milestone_id" id="task-milestone">
                        ...
                        <?php $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($milestone->id); ?>" <?php if($task->milestone_id == $milestone->id): ?> selected <?php endif; ?>>
                                <?php echo e($milestone->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="multi-select" multiple="multiple" id="assign_to" name="assign_to[]" required>
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if(in_array($u->id, $task->assign_to)): ?> selected <?php endif; ?> value="<?php echo e($u->id); ?>">
        ...
        $(function() {
            ...
            $('form #duration').daterangepicker({
                ...
                locale: {
                    ...
                    daysOfWeek: [
                        "<?php echo e(__('messages.Sun')); ?>",
                        "<?php echo e(__('messages.Mon')); ?>",
                        "<?php echo e(__('messages.Tue')); ?>",
                        "<?php echo e(__('messages.Wed')); ?>",
                        "<?php echo e(__('messages.Thu')); ?>",
                        "<?php echo e(__('messages.Fri')); ?>",
                        "<?php echo e(__('messages.Sat')); ?>",
                    ],
                    monthNames: [
                        "<?php echo e(__('messages.January')); ?>",
                        "<?php echo e(__('messages.February')); ?>",
                        "<?php echo e(__('messages.March')); ?>",
                        "<?php echo e(__('messages.April')); ?>",
                        "<?php echo e(__('messages.May')); ?>",
                        "<?php echo e(__('messages.June')); ?>",
                        "<?php echo e(__('messages.July')); ?>",
                        "<?php echo e(__('messages.August')); ?>",
                        "<?php echo e(__('messages.September')); ?>",
                        "<?php echo e(__('messages.October')); ?>",
                        "<?php echo e(__('messages.November')); ?>",
                        "<?php echo e(__('messages.December')); ?>",
                    ],
                }
            }, cb);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/projects/taskEdit.blade.php ENDPATH**/ ?>