...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('messages.Company')); ?>
...
<?php $__env->startSection('links'); ?>
    ...
    <?php endif; ?>
    <li class="breadcrumb-item"> <?php echo e(__('messages.company')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="card   text-center">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <?php if(isset($currentWorkspace) &&
                                                    ...
                                                    <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                        data-size="md" data-title="<?php echo e(__('Edit')); ?>"
                        ...
                        <?php if(Auth::user()->type == 'admin' && Auth::user()->id != $user->id): ?>
                            <div class="text-end"
                                <?php if(Auth::user()->type == 'admin'): ?> style="margin: -10px -10px -30px;" <?php endif; ?>>
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="<?php echo e(route('login.with.admin', $user->id)); ?>" class="dropdown-item">
                                            ...
                                            <span><?php echo e(trans('messages.Login_As_Admin')); ?></span>
                        ...
                        <div class="card-body">
                            <div class="avatar">
                                <img alt="user-image" class=" rounded-circle img_users_fix_size"
                                    <?php if($user->avatar): ?> src="<?php echo e($logo . $user->avatar); ?>" <?php else: ?> avatar="<?php echo e($user->name); ?>" <?php endif; ?>>
                            </div>
                                    ...
                                    <div class="row px-2">
                                        <?php if(Auth::user()->type == 'admin'): ?>
                                            <div class="col-6 text-start">
                                                ...
                                                <p class="text-muted text-sm mb-0"><?php echo e(trans('messages.Workspaces')); ?></p>
                                            </div>
                                            <div
                                                ...
                                                <p class="text-muted text-sm mb-0"><?php echo e(trans('messages.Users')); ?></p>
                                            </div>
                                            <div class="col-6 text-start mt-2">
                                                <h6 class="mb-0 px-3"><?php echo e($user->countClients($workspace_id)); ?></h6>
                                                <p class="text-muted text-sm mb-0"><?php echo e(trans('messages.Clients')); ?></p>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(Auth::user()->type == 'admin'): ?>
                                            <div class="col-12 text-center Id mt-3">
                                                <a href="#" data-url="<?php echo e(route('company.info', $user->id)); ?>"
                                                    ...
                                                    data-title="<?php echo e(__('Company Info')); ?>"><?php echo e(trans('messages.AdminHub')); ?></a>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(Auth::user()->type != 'admin'): ?>
                                            <div class="col-6 text-end">
                                                ...
                                                <p class="text-muted text-sm mb-0"><?php echo e(trans('messages.Tasks')); ?></p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                ...
                <?php if(auth()->guard('web')->check()): ?>
                    <?php if(Auth::user()->type == 'admin'): ?>
                        ...
                        <a href="#" class="btn-addnew-project" data-ajax-popup="true" data-size="md"
                            ...
                            <h6 class="mt-4 mb-2"><?php echo e(trans('messages.Invite_New_User')); ?></h6>
                            <p class="text-muted text-center"><?php echo e(trans('messages.Clich_here_to_Invite_New_User')); ?></p>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/users/index.blade.php ENDPATH**/ ?>