...
?>
<?php $__env->startSection('page-title'); ?> <?php echo e(trans('messages.Timesheet')); ?> <?php $__env->stopSection(); ?>
                                ...
                                <div class="page-inner">
                                    ...
                                    <div class="page-search">
                                        <p class="text-muted mt-3">
                                            ...
                                            <br>
                                            <?php if($project_id != '-1' && Auth::user()->getGuard() != 'client'): ?>
                                                <?php echo e(trans('messages.To_add_timesheet_record_go_to ')); ?> <b><?php echo e(__('Add Task on Timesheet.')); ?></b>
                                            <?php else: ?>
