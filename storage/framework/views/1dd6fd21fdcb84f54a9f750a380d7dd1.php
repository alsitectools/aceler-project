<div class="card-body table-border-style">
    <div class="table-responsive ">
        <table class="table mb-0">
            <thead>
                <tr>
                    <th class="text-muted"><?php echo e(__('messages.Task')); ?></th>
                    <?php $__currentLoopData = $days['datePeriod']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $perioddate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <th class="text-dark m-0 "><?php echo e(utf8_encode(strftime('%a %d %b', $perioddate->getTimestamp()))); ?>
                    ...
                    <?php $__currentLoopData = $timesheetArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $timesheet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="">
                            <td colspan="9"><span data-tooltip="Project"
                                    class="project-name pad_row custom-tooltip"><?php echo e($timesheet['project_name']); ?></span>
                            </td>
                        </tr>
                                        ...
                                        <td>
                                            <?php if(auth()->guard('client')->check()): ?>
                                                <div class="form-control border-dark wid-120">
                                                    <?php echo e($dateSubArray['time'] != '00:00' ? $dateSubArray['time'] : '00:00'); ?>
                                                ...
                                                <?php if(
                                                    ...
                                                    <div role="button" class="form-control border-dark wid-120"
                                                        title="<?php echo e($dateSubArray['type'] == 'edit' ? __('Click to Edit/Delete Timesheet') : __('Click to Add Timesheet')); ?>"
                                                        data-ajax-timesheet-popup="true"
                                                        data-type="<?php echo e($dateSubArray['type']); ?>"
                                                        data-user-id="<?php echo e($dateTimeArray['user_id']); ?>"
                                                        data-project-id="<?php echo e($timesheet['project_id']); ?>"
                                                        data-task-id="<?php echo e($taskTimesheet['task_id']); ?>"
                                ...
                                <td>
                                    <?php if(auth()->guard('client')->check()): ?>
                                        <div class="form-control border-dark">
                                            <?php echo e($datetime['time'] != '00:00' ? $datetime['time'] : '00:00'); ?></div>
                                        <?php elseif(auth()->guard()->check()): ?>
                                        <?php if(Auth::user()->currant_workspace == $currentWorkspace->id && $currentWorkspace->created_by == Auth::user()->id): ?>
                                            <div role="button" class="form-control border-dark wid-120"
                                                title="<?php echo e($datetime['type'] == 'edit' ? __('Click to Edit/Delete Timesheet') : __('Click to Add Timesheet')); ?>"
                                                data-ajax-timesheet-popup="true" data-type="<?php echo e($datetime['type']); ?>"
                                                data-task-id="<?php echo e($timesheet['task_id']); ?>"
                                                data-date="<?php echo e($datetime['date']); ?>" data-url="<?php echo e($datetime['url']); ?>">
                                                <?php echo e(isset($datetime['total_task_time']) ? $datetime['total_task_time'] : '00:00'); ?>
...
<div class="text-center d-flex align-items-center justify-content-center  mt-4 mb-5">
    <h5 class="f-w-900 me-2 mb-0"><?php echo e(__('messages.Time_Logged:')); ?></h5>
    <span class="p-2  f-w-900 rounded  bg-primary d-inline-block border border-dark">
        <?php echo e($calculatedtotaltaskdatetime); ?></span>
</div>
...
<?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/projects/timesheet-week.blade.php ENDPATH**/ ?>