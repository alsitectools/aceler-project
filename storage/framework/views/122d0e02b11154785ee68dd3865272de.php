    ...
    <form class="" method="post"
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="milestone-status" class="col-form-label"><?php echo e(__('messages.Status')); ?></label>
                        <select class="form-control select2" name="status" id="milestone-status" required>
                            <option value="incomplete" <?php if($milestone->status == 'incomplete'): ?> selected <?php endif; ?>>
                                <?php echo e(__('Incomplete')); ?></option>
                            <option value="complete" <?php if($milestone->status == 'complete'): ?> selected <?php endif; ?>>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group ">
                        <label class="form-label"><?php echo e(__('messages.Date_created')); ?></label>
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control form-control-light" id="task-summary" rows="3" name="summary" disabled><?php echo e($milestone->summary); ?></textarea>
            </div>
