                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="mb-3"><?php echo e(trans('messages.Total Users')); ?></h6>
        ...
        <?php elseif($currentWorkspace): ?>
            <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class=""><?php echo e(trans('messages.Total_Project')); ?></h6>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm "></p>
                                    <h6 class=""><?php echo e(trans('messages.Total_Task')); ?></h6>
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted text-sm"></p>
                                    <h6 class=""><?php echo e(trans('messages.Total_User')); ?></h6>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-auto d-flex justify-content-end">
                                    <div class="">
                                        <small><b><?php echo e($completeTask); ?></b> <?php echo e(trans('messages.Tasks_completed_out_of')); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="text-muted font-13"><?php echo e(trans('messages.Status')); ?></span>
                                                    <br />
                                                ...
                                                <?php if($currentWorkspace->permission == 'Owner' || Auth::user()->getGuard() == 'client'): ?>
                                                    <td>
                                                        ...
                                                        <div class="font-14 mt-1 font-weight-normal">
                                                            <?php $__currentLoopData = $task->taskUsers(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <span
                                                                    class="badge p-2 px-2 rounded bg-secondary"><?php echo e(isset($tasksUsers[$user]) ? $tasksUsers[$user] : '-'); ?></span>
                ...
                <div class="col-lg-5 col-md-5 ">
                    <div class="card">
                        <div class="card-header">
                            <h5><?php echo e(trans('messages.Tasks_Overview')); ?></h5>
                                ...
                                <div class="col-sm-6  pb-5 px-3">
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            ...
                                            <span class="ms-2 text-sm"><?php echo e(trans('messages.On_Going')); ?></span>
                                        </span>
                                    </div>
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            <i class="f-10 lh-1 fas fa-circle" style="color: #3cb8d9;"></i>
                                            <span class="ms-2 text-sm"><?php echo e(trans('messages.On_hold')); ?></span>
                                        </span>
                                    </div>
                                    <div class="col-12 col-sm-10">
                                        <span class="d-flex justify-content-center align-items-center mb-2">
                                            <i class="f-10 lh-1 fas fa-circle" style="color: #6095c1; "></i>
                                            <span class="ms-2 text-sm"><?php echo e(trans('messages.Finished')); ?></span>
                                        </span>
                                    </div>
                                </div>
        ...
        <script>
            (function() {
                var options = {
                    ...
                    title: {
                        text: '<?php echo e(trans('messages.Tasks')); ?>'
                    },
                };
                var chart = new ApexCharts(document.querySelector("#task-area-chart"), options);
                chart.render();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ws-karla\laravel-api\main_task\resources\views/home.blade.php ENDPATH**/ ?>